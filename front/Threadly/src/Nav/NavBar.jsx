...
function NavBar() {
    ...
    const [userType, setUserType] = useState("admin"); //TODO: Change this ASAP
    ...
    return <><div className={styles.navBar}>
        ...
        {userClicked &&
            <div className={styles.userMenu}>
                <span className={styles.userText}>{isConnected ? `Hello, ${username}` : "Not connected"}</span>
                <div className={styles.logInTabs}>
                    ...
                    {userType == "admin" && <span className={styles.logInText} onClick={()=>navigate("/admin")}>Admin</span>}
                </div>
            </div>}
                ...
                <div className={styles.registerBox}>
                    ...
                    <form>
                        ...
                        <div className={styles.formDiv}>
                            ...
                            <input ref={passwordRef} value={registerPass} onChange={handlePassChange} type="password" id="pass" required />
                        </div>
                        <div className={styles.formDiv} >
                            <label>Confirm Password</label>
                            <input ref={confirmPasswordRef} value={confirmPass} onChange={handleConfirmChange} type="password" id="confirmPass" required />
                        </div>
                        <button className={styles.confirmButton}></button>
                    </form>
                </div>
            </>
        }
