...
function Collection({ title }) {
    ...
    function removeImage(index){
        ...
        let updatedArray = focusedInfo["images"].filter((_, i) => i !== index); // Removekeyword at given index
        let updatedArrayJSON = { ...focusedInfo["images"], "images": updatedArray };
        ...
        setFocusedInfo(updatedArrayJSON); // Set the updated keywords array back into state
    }
